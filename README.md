...
CookBook היא אפליקציית ווב המאגדת מתכונים מבלוגי בישול מובילים בישראל (ניקי במטבח, 10 דקות, חן במטבח ועוד) תחת ממשק אחד נוח ומסודר.  
...
**משפחות ישראליות** שמחפשות השראה לבישול יומיומי — מי שכבר מכיר בלוגי בישול ישראליים ורוצה לנהל את המתכונים האהובים עליו במקום אחד.
...
| allrecipes.com | מתכונים בעברית מעטים |
